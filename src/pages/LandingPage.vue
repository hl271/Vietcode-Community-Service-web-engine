    ...
    <div>
        ...
        <div class="wrapper">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6">
                    <div class="image-container image-left" style="background-image: url('/static/img/login.jpg')">
                    ...
                    <div class="image-container" style="background-image: url('/static/img/bg3.jpg')"></div>
                    </div>
                    <div class="col-md-5">
                    <!-- First image on the right side, above the article -->
                    <div class="image-container image-right" style="background-image: url('/static/img/bg1.jpg')"></div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="team-player">
                        <img src="/static/img/avatar.jpg" alt="Thumbnail Image" class="rounded-circle img-fluid img-raised">
                    ...
                    <div class="col-md-4">
                    <div class="team-player">
                        <img src="/static/img/ryan.jpg" alt="Thumbnail Image" class="rounded-circle img-fluid img-raised">
                    ...
                    <div class="col-md-4">
                    <div class="team-player">
                        <img src="/static/img/eva.jpg" alt="Thumbnail Image" class="rounded-circle img-fluid img-raised">
...
<script>
require('../assets/js/plugins/bootstrap-switch.js')
require('../assets/js/plugins/nouislider.min.js')
require('../assets/js/now-ui-kit.min.js')
export default {
